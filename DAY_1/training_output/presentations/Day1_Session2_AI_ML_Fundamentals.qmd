...
format:
  revealjs:
    ...
    css: styles.css
    footer: "CopPhil Training | Day 1 Session 2"
...
- Appreciate **data-centric AI** philosophy
:::
...
::: {.notes}
This session covers fundamental AI/ML concepts tailored to EO applications. It's mostly conceptual, setting the groundwork for hands-on work in later sessions and days.
:::
...
![](images/ai_ml_dl_venn.png){fig-align="center" width="60%"}
...
::: {.notes}
AI is the broadest term. Machine Learning is a subset where computer algorithms learn patterns from data without being explicitly programmed. Deep Learning uses neural networks.
:::
...
![](images/ml_classification_example.jpg){fig-align="center" width="60%"}
...
![](images/before_preprocessing.jpg){width="100%"}
...
![](images/after_preprocessing.jpg){width="100%"}
...
::: {.notes}
Preprocessing transforms raw satellite data into analysis-ready products. This often involves cloud masking and creating composites.
:::
...
# Data-Centric AI in EO {background-color="#1e3a8a"}
...
- Prithvi, Clay, SatMAE models
- Planet Labs + Anthropic Claude integration
:::

::: {.notes}
Foundation models are revolutionizing EO by providing powerful, general-purpose representations that can be adapted for various tasks with minimal labeled data.
:::
...
::: {.notes}
A major 2025 trend is moving AI processing directly onto satellites, enabling real-time analysis and reducing data transmission requirements.
:::
...
::: {.notes}
Take time for questions and discussion. These foundational concepts need to be clear before the hands-on sessions.
:::

# Break Time {background-color="#1e3a8a"}

**15-minute break**

Next up: Session 3 - Hands-on Python for Geospatial Data

::: {.fragment}
**After the break, you'll get hands-on with real satellite data!**
:::
