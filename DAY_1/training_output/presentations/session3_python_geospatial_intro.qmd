...
format:
  revealjs:
    ...
    footer: "Session 3: Python for Geospatial | CopPhil Training 2025"
    slide-number: true
    progress: true
    history: true
    center: true
...
::: {.column width="40%"}
![Google Colab Logo](images/colab-logo.png){width=100%}
:::
:::
...
::: {.column width="50%"}
![Colab Interface](images/colab-interface.png){width=100%}
:::
:::
...
::: {.column width="40%"}
![GeoPandas Logo](images/geopandas-logo.png){width=100%}
:::
:::
...
::: {.column width="40%"}
![Rasterio](images/rasterio-logo.png){width=80%}
:::
:::
