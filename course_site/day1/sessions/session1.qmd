...
[📥 Download PDF](session1.pdf){.btn .btn-primary target="_blank"}
:::
...
- **Explain** how CopPhil integrates European and Philippine EO capabilities
- **Access** the CopPhil Mirror Site and Digital Space Campus for continued learning
:::
...
::: {.callout-tip}
## View Full Screen
Click the presentation above and press `F` for fullscreen mode. Use arrow keys to navigate slides.

[Open in new tab →](../presentations/01_session1_copernicus_philippine_eo.html){target="_blank" .btn .btn-sm .btn-primary}
:::
...
- **CopPhil/Digital Space Campus:** Hosts training materials + local data access (400TB)
...
## Part 6: CopPhil Programme - Bridging Europe and the Philippines

### CopPhil Overview

**Full Name:** National Copernicus Capacity Support Action Programme for the Philippines (CopPhil)
...
- PhilSA, DOST, and EU jointly launch CopPhil
...
- Launch of CopPhil Infrastructure website
- Moderated by broadcast journalist Atom Araullo

**November 2024:**
- CopPhil Infrastructure website fully operational
...
- EU CopPhil Scholarship Programme active
...
### CopPhil Infrastructure (Mirror Site)
...
CopPhil is co-developing three operational pilot services tailored to Philippine priorities:
...
- **First major real-world application demonstrating CopPhil's operational readiness**
...
2. **Sentinel-1 SAR (via CopPhil)** → Detect flood extent under clouds
...
**Data Integration:**
1. **Sentinel-2 time series (via CopPhil)** → Multi-temporal optical imagery
...
**Workflow:**
1. Download Sentinel-2 time series for province from CopPhil
...
**Data Integration:**
1. **Sentinel-2 NDVI time series (CopPhil)** → Vegetation health indicator
...
**Data Integration:**
1. **Sentinel-2 coastal imagery (CopPhil)** → Shallow water habitat
2. **CopPhil Benthic Habitat pilot service** → Classification algorithms
...
2. Apply CopPhil benthic habitat classification
...
- Which training courses on CopPhil Digital Campus interest you most?
:::
...
- CopPhil infrastructure enables local storage, processing, and capacity building

**Your Next Steps:**
- Register for CopPhil Infrastructure access
- Explore CopPhil Digital Campus training courses
- Consider EU CopPhil Scholarship Programme (if eligible)
...
- [ESA CopPhil Announcement](https://www.esa.int/Applications/Observing_the_Earth/Copernicus/ESA_and_the_European_Commission_uniting_on_Earth_observation_for_the_Philippines)
