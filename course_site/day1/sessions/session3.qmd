...
[📥 Download PDF](session3.pdf){.btn .btn-primary target="_blank"}
:::
...
[Open in new tab →](../presentations/03_session3_python_geospatial.html){target="_blank" .btn .btn-sm .btn-primary}
:::
...
import shutil
shutil.copy('important_result.tif', '/content/drive/MyDrive/CopPhil_Training/outputs/')
```
...
```python
# Save as shapefile
aoi_gdf.to_file('/content/drive/MyDrive/CopPhil_Training/data/vector/my_aoi.shp')

# Or save as GeoJSON (more portable)
aoi_gdf.to_file('/content/drive/MyDrive/CopPhil_Training/data/vector/my_aoi.geojson', driver='GeoJSON')
```
...
output_path = '/content/drive/MyDrive/CopPhil_Training/outputs/ndvi.tif'
...
```python
clipped_path = '/content/drive/MyDrive/CopPhil_Training/outputs/clipped_raster.tif'
...
survey_points.drop('geometry', axis=1).to_csv(
    '/content/drive/MyDrive/CopPhil_Training/outputs/field_validation.csv',
    index=False
)

# Or save as shapefile with geometry
survey_points.to_file(
    '/content/drive/MyDrive/CopPhil_Training/outputs/field_validation.shp'
)
...
BASE_DIR = Path('/content/drive/MyDrive/CopPhil_Training')
