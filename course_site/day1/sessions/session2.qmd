...
[Open in new tab →](../presentations/02_session2_ai_ml_fundamentals.html){target="_blank" .btn .btn-sm .btn-primary}
:::
...
- **CopPhil Mirror Site (2025):** Local, high-bandwidth access to Sentinel data covering entire archipelago
...
- **CopPhil Data Centre (2025):** Cloud-native distribution with API-driven access
...
- CopPhil training programs on labeling best practices
...
23. **CopPhil Data Centre (2025):** Local, high-bandwidth access to Sentinel data, cloud-native distribution
24. **Leverage existing infrastructure:** DIMER, AIPI, ALaM, CopPhil to operationalize AI/ML workflows
...
10. **CopPhil opportunities:** How can you leverage the upcoming Data Centre and training programs? What collaborations would be valuable?
:::
...
- [CopPhil Centre](https://copphil.philsa.gov.ph/)
