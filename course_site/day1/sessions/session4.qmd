...
[Open in new tab →](../presentations/04_session4_google_earth_engine.html){target="_blank" .btn .btn-sm .btn-primary}
:::
...
flowchart LR
    ...
    K --> M[Google Drive<br/>CopPhil_Training/<br/>filename.tif]
