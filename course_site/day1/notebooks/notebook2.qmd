...
### 📘 **Notebook 1: GEE Fundamentals** (Start Here)
...
::: {.colab-button}
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/DimitrisKasabalis/EO_trainning/blob/main/day1/notebooks/Day1_Session4_Google_Earth_Engine.ipynb)
:::
...
**Download Option:**
::: {.download-box}
[Download Notebook 1 .ipynb](Day1_Session4_Google_Earth_Engine.ipynb){.btn .btn-primary}
:::
...
✅ **After completing Notebook 1**
✅ **For operational/production work**
✅ **When QA60 results have "ghost" clouds or shadows**
...
1. ✅ Complete **Notebook 1** in full (2 hours)
2. ✅ Practice exercises
3. ✅ (Optional) Try **Notebook 2** to see advanced techniques

### 🎯 For Experienced Users / Refresher:
1. ✅ Skim **Notebook 1** sections 1-3 (setup and basics)
2. ✅ Focus on **Notebook 2** for P0 improvements
3. ✅ Use as reference for production workflows

### 🎯 For Production / Operational Work:
1. ✅ Use **Notebook 2** as template
2. ✅ Reference **Notebook 1** for comprehensive examples
3. ✅ Adapt SCL or s2cloudless masking to your use case
...
| **P0 Alignment** | Standard approach | ✅ Implements P0 improvement |
