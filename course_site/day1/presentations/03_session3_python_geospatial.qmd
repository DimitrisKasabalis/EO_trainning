...
subtitle: "CopPhil EO AI/ML Training - Day 1, Session 3"
...
format:
  revealjs:
    theme: default
    css: custom.scss
    footer: "Day 1 Session 3 | Python Geospatial"
    slide-number: true
    progress: true
    history: true
    center: true
...
**Key Point:**
This is a HANDS-ON session. Participants code along in their notebooks. Instructor demonstrates, then participants practice.
:::
...
::: {.column width="40%"}
![Google Colab Logo](/images/icons8-google-colab-color/icons8-google-colab-240.svg){width=80%}
:::
:::

::: notes
Google Colab is perfect for training environments. Everyone has the same setup, no compatibility issues, and free access to powerful computing resources.
:::
...
4. **Easy Sharing**
   ...
   - CopPhil materials readily accessible
:::
...
::: notes
Take a few questions, then transition to the hands-on Colab notebooks. The rest of the session will be interactive coding with live instructor demonstration and support.
:::
