...
institute: "EU-Philippines CopPhil Programme"
...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    footer: "Day 1 Session 1 | Copernicus & Philippine EO"
...
| **Large-Scale Processing** | **CopPhil Mirror Site / COARE** | 400TB local data, HPC resources | Requires account; learning curve for APIs |
...
- **CopPhil/Digital Space Campus**: Hosts this training's materials + local data access
:::
...
- CopPhil infrastructure enables local processing
...
::: {.fragment}
**Now Available: CopPhil Mirror Site in the Philippines!** (Operational 2024-2025)
:::

::: {.notes}
**MICRO-EDIT APPLIED:** Mirror Site is NOW operational (not "coming soon").

Multiple platforms provide Sentinel data access. The CopPhil Mirror Site provides **local data access in the Philippines for faster downloads** - critical for reducing international bandwidth bottlenecks.
...
- [ ] CopPhil Infrastructure registration ([application.infra.copphil.philsa.gov.ph](https://application.infra.copphil.philsa.gov.ph))
