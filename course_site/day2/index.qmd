...
::: {.session-nav}
[← Back to Day 1](../day1/index.qmd){.btn .btn-outline-primary}
[Start Session 1 →](sessions/session1.qmd){.btn .btn-primary}
:::

---

*Day 2 is part of the CopPhil 4-Day Advanced Training on AI/ML for Earth Observation, funded by the European Union under the Global Gateway initiative and delivered in partnership with PhilSA and DOST.*
