...
[Open in new tab →](../presentations/session1_unet_segmentation.html){target="_blank" .btn .btn-sm .btn-primary}
:::
...
::: {.session-nav}
[← Back to Day 3 Overview](../index.qmd){.btn .btn-outline-secondary}
[Next: Session 2 - Flood Mapping Lab →](../notebooks/Day3_Session2_Flood_Mapping_UNet.ipynb){.btn .btn-primary}
:::

---

*This session is part of the CopPhil 4-Day Advanced Training on AI/ML for Earth Observation, funded by the European Union under the Global Gateway initiative.*
