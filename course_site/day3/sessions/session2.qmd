...
[Open in new tab →](../presentations/session2_flood_mapping_lab.html){target="_blank" .btn .btn-sm .btn-primary}
:::
...
::: {.session-nav}
[← Back to Session 1](session1.qmd){.btn .btn-outline-secondary}
[Next: Session 3 - Object Detection →](session3.qmd){.btn .btn-primary}
:::

---

*This hands-on lab is part of the CopPhil 4-Day Advanced Training on AI/ML for Earth Observation, funded by the European Union under the Global Gateway initiative. Materials developed in collaboration with PhilSA, DOST-ASTI, and the European Space Agency.*
